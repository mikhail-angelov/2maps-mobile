...
const Login: FC<LoginProps> = ({error, login, setSignUp, setPasswordReset}) => {
  ...
  return (
    <View style={styles.content} accessibilityLabel={t('Login')}>
      ...
      <Button
        titleStyle={[styles.inlineBtn, styles.inlineBtnPwd]}
        type="clear"
        onPress={setPasswordReset}
...
const SignUp: FC<SignUpProps> = ({error, signUp, back, isAuthInProgress}) => {
  ...
  return (
    <View style={styles.content} accessibilityLabel={t('Sign Up')}>
  ...
  if (isAuthenticated) {
    ...
    content = (
      <Login
        error={error}
        login={login}
        setSignUp={() => setUi('signUp')}
        setPasswordReset={() => setUi('passwordReset')}
      />
    );
  } else if (ui === 'signUp') {
    content = (
...
const ForgetPassword: FC<PasswordResetProps> = ({
  error,
  passwordReset,
  back,
  setAuthError,
  ...
  return (
    <View style={styles.content} accessibilityLabel={t('Reset your password')}>
