...
public class OzfMap {
    ...
    public static OzfReader load(String file, String charset) throws IOException
    {
        if (projections == null)
        {
            initialize();
        ...
        File fm = new File(file+".map");

        InputStream is = new FileInputStream(fm);
...
//        }
        ...
        BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(fm), charset));

//        OzfMap map = new OzfMap(file.getCanonicalPath());
        File f = new File(file+".ozf2");
        OzfReader map = new OzfReader(f);
        try
        {
            String[] fields;
...
//            map.loadError = e;
    ...
    private static void fixCoords(OzfReader map, Datum datum)
    {
    ...
    private static void fixCalibration(OzfReader map)
    {
        for (MapPoint mp : map.calibrationPoints)
        {
    ...
    private static void fixCornerMarkers(OzfReader map)
    {
        if (map.cornerMarkers != null)
        {
    ...
    private static void parseProjectionParams(OzfReader map, String[] fields)
    {
        try
        {
    ...
    private static MapPoint parsePoint(OzfReader map, String[] fields)
    {
    ...
    private static void parseLLGrid(OzfReader map, String[] fields)
    {
        Grid grid = new Grid();
...
//        }
    ...
    private static void parseOtherGrid(OzfReader map, String[] fields)
    {
        Grid grid = new Grid();
        grid.enabled = "Yes".equals(fields[1]);
        try
